...
async def story_qince(zl_story: Matcher):
...
async def story_qinxu(zl_story: Matcher):
...
async def story_guili_1(zl_story: Matcher):
...
async def story_stone_bird(zl_story: Matcher):
...
async def story_cenyan_2(zl_story: Matcher):
...
async def story_fulong(zl_story: Matcher):
...
async def story_contract(zl_story: Matcher):
...
async def story_sword(zl_story: Matcher):
...
async def story_spear(zl_story: Matcher):
...
async def story_bishui(zl_story: Matcher):
...
async def story_hanwu(zl_story: Matcher):
...
async def story_tianheng(zl_story: Matcher):
...
async def story_geobutterfly(zl_story: Matcher):
...
async def story_record(zl_story: Matcher):
